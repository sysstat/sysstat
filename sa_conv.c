 ...
 * (C) 1999-2026 by Sebastien GODARD (sysstat <at> orange.fr)
 *
 ***************************************************************************
			  ...
			  int endian_mismatch, int arch_64)
{
	...
	if (st_size >= STATS_MEMORY_8A_SIZE) {
		...
		/*
		 * If availablekb was non existent in the original file then
		 * set it to the same value as frmkb (free memory).
		 * This prevents %memused from being displayed as 100% in this case.
		 */
